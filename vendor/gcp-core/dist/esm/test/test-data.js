...
const commonVenues = [
    {
        name: 'Den Haag Rugby Football Club',
        coordinates: { latitude: 54.4, longitude: 4.2 },
    },
    {
        name: 'Die Haag FC',
        coordinates: { latitude: 54.3, longitude: 4.1 },
    },
];
const commonPitches = [
    {
        ...
        t2: {
            ...
            categories: {
                Mens: {
                    ...
                    groups: [
                        ["Luxembourg A", "Paris Gaels A", "Viking Gaels", "Hague/Paris B"],
                        ["Amsterdam", "Eindhoven", "Belgium A", "Hamburg/Nijmegen"],
                        ["Leuven/Cologne", "Lux B/Belg B", "Darmstadt/Rome", "Prague/Vienna"],
                    ],
                },
            },
            activities: [],
